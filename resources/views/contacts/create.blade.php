                  ...
                  <div class="flex flex-wrap -m-2">
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <x-input-error :messages="$errors->get('name')" class="text-xs mt-2" />
                      </div>
                    </div>
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <x-input-error :messages="$errors->get('title')" class="text-xs mt-2" />
                      </div>
                    </div>
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <x-input-error :messages="$errors->get('url')" class="text-xs mt-2" />
                      </div>
                    </div>
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <x-input-error :messages="$errors->get('gender')" class="text-xs mt-2" />
                      </div>
                    </div>
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <x-input-error :messages="$errors->get('age')" class="text-xs mt-2" />
                      </div>
                    </div>
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <x-input-error :messages="$errors->get('contact')" class="text-xs mt-2" />
                      </div>
                    </div>
                    ...
                    <div class="p-2 w-full">
                      ...
                      <x-input-error :messages="$errors->get('caution')" class="text-xs mt-2" />
                    </div>
